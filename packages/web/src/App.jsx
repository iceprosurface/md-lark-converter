...
import { writeToClipboard, readClipboard } from './lib/clipboard/browserClipboard.js';
import DebugComparison from './components/DebugComparison.jsx';

function extractLarkDataFromHtml(html) {
...
function App() {
  const [markdown, setMarkdown] = React.useState('# 标题\n\n这是示例文本。\n\n- 列表项 1\n- 列表项 2');
  const [convertedData, setConvertedData] = React.useState(null);
  const [clipboardData, setClipboardData] = React.useState(null);
